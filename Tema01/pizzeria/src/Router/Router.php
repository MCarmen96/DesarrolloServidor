...
class Router{
    ...
    public function loadRoutes(){
        ...
        $this->routes["/delPizza"]=["controller"=>"appController","action"=>"delete"];
        $this->routes["/edit"]=["controller"=>"appController","action"=>"edit"];
        $this->routes["/saveEdit"]=["controller"=>"appController","action"=>"saveEdit"];
        $this->routes["/createPizza"]=["controller"=>"appController","action"=>"create"];
        $this->routes["/saveCreate"]=["controller"=>"appController","action"=>"saveCreate"];
    }
