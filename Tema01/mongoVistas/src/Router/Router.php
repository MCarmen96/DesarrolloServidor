...
class Router{
    ...
    public function loadRoutes(){
        ...
        $this->routes["/departNew"]=["controller"=>"appController","action"=>"departNew"];
        $this->routes["/create"]=["controller"=>"appController","action"=>"create"];
        $this->routes["/delete"]=["controller"=>"appController","action"=>"delete"];
        $this->routes["/edit"]=["controller"=>"appController","action"=>"edit"];
        $this->routes["/update"]=["controller"=>"appController","action"=>"update"];
