...
<!-- MIRAR EL EL SEGUNDO PARAMETRO DEL ROUTE -->
<form action="{{ route('emples.update', $emple->emple_no) }}" method="POST">
    ...
    <input type="number"  name="salario" value="{{ $emple->salario }}" required><br><br>
    <input type="number"  name="comision" value="{{ $emple->comision }}"><br><br>
